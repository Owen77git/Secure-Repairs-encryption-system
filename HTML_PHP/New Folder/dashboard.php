...
<body>
  ...
  <main class="dashboard">
    ...
    <aside class="sidebar">
      <h2>Menu</h2>
      <ul>
        <a href="manage~technician.php"><li>Manage Technicians</li></a>
        <a href="cctv~monitoring.HTML"><li>CCTV Monitoring</li></a>
        <a href="manage_tools.php"><li>Manage Tools</li></a>
