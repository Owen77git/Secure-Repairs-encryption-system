  ...
  <header class="navbar">
    ...
    <nav class="nav-links">
      <a href="dashboard.php">Dashboard</a>
            <a href="manage~technician.php" class="active">manage technicians</a>
        ...
        <tr>
          ...
          <td style="position: relative;">
            ...
            <div class="dropdown">
              ...
              <a href="?update_status=<?= $row['id'] ?>&new_status=monitored">Monitored</a>
              <a href="?delete=<?= $row['id'] ?>" onclick="return confirm('Delete this technician?')" class="delete">Delete</a>
            </div>
          </td>
        </tr>
        <?php } ?>
